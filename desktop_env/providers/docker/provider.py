...
WAIT_TIME = 3
RETRY_INTERVAL = 1
# Timeout for acquiring the port-allocation lock. With many EnvWorkers (e.g. 16),
# they queue; each holds the lock during port allocation + container start.
# 10s is too short; use a value that allows all workers to wait their turn.
LOCK_TIMEOUT = 180
...
class DockerProvider(Provider):
    def __init__(self, region: str, docker_image: str = None):
        ...
        self.vlc_port = None
        self.container = None
        self.docker_image = docker_image or os.environ.get("OSWORLD_DOCKER_IMAGE", DEFAULT_DOCKER_IMAGE)
