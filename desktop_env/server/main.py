...
def run_bash_script():
    ...
    try:
        ...
        # Log bash execution without relying on removed trajectory helper.
        logger.info(
            "BashScript executed: returncode=%s output_len=%s",
            result.returncode,
        ...
        try:
            ...
            logger.info(
                "BashScript(sh fallback) executed: returncode=%s output_len=%s",
                result.returncode,
                len(result.stdout or ""),
            )
